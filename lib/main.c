...
void initializeSDL(SDL_Window **window, SDL_Renderer **renderer) {
    ...
    *window = SDL_CreateWindow("Traffic Queue", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, WINDOW_WIDTH, WINDOW_HEIGHT, SDL_WINDOW_SHOWN);
    *renderer = SDL_CreateRenderer(*window, -1, SDL_RENDERER_ACCELERATED);
    SDL_SetRenderDrawColor(*renderer, 0, 0, 0, 0); // Set background color to white
}
